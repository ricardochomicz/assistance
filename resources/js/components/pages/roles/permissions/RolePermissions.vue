        ...
        <div class="card">
            ...
            <div class="card-header">
                <h3 class="card-title mb-0">
                    <i class="fas fa-id-badge mr-2"></i> Permissões do Cargo -
                    <strong>{{ name }}</strong>
                </h3>
...
export default {
    ...
    methods: {
        getRoleById() {
            axios
                .get(`${URL}/${RESOURCES.ROLES}/${this.$route.params.id}`, {
        ...
        getPermissions(page = 1) {
            axios
                .get(
                    `${URL}/${RESOURCES.ROLES}/${this.$route.params.id}/${RESOURCES.PERMISSIONS}?page=` +
                        page,
                    {
                        headers: { Authorization: "Bearer " + TOKEN }
                    }
        ...
        detachPermission(id) {
            axios
                .get(
                    `${URL}/${RESOURCES.ROLES}/${this.$route.params.id}/${RESOURCES.PERMISSIONS}/${id}/detach`,
                    {
                        headers: { Authorization: "Bearer " + TOKEN }
                    }
                )
